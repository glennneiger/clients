...
php wp-cli.phar core config --dbhost=intranetuswww.mysql.db --dbname=intranetuswww --dbuser=intranetuswww --dbpass=YU64BJdN9jRyDhyxnyQY48kpVd3t4d --dbprefix=wp_aaaaaaaaaaa_ --skip-check --extra-php <<PHP
...
# launch install
bot "et j'installe !"
php wp-cli.phar core install --url="https://sem-web.fr/clients/aaaaaaaaaaa" --title="aaaaaaaaaaa" --admin_user=alopin --admin_email=alopin@sem-web.fr --admin_password="$password"  <<PHP
define( 'WP_DEBUG', true );
PHP
...
git commit -m "Online commit aaaaaaaaaaa"   # Commit changes
git push
...
# Open in browser
#open https://sem-web.fr/clients/aaaaaaaaaaa
...
line
echo "URL du site:   https://sem-web.fr/aaaaaaaaaaa"
